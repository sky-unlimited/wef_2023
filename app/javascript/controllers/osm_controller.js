...
export default class extends Controller {
  ...
  displayMap() {
    ...
    */
    ...
    var flyZoneOutbound = L.geoJSON(this.flyzoneOutboundValue, {
      style: myStyle,
    });
    ...
    */
    ...
    var flyZoneInbound = L.geoJSON(this.flyzoneInboundValue, {
      style: myStyle,
    });
    ...
    */
    ...
    var flyzoneCommonPolygon = L.geoJSON(this.flyzoneCommonPolygonValue, {
      style: myStyle,
    });
    ...
    for (var i = 0; i < 5; i++) {
      var circle = L.circle(
        ...
        ],
        {
          ...
          radius:
            (i + 1) *
            (this.pilotPrefsValue.average_true_airspeed * 1.852) *
            1000,
        }
      );
    ...
    */
    ...
    var Overlays = {
      ...
      [`Fly Zone outbound - ${this.dateToString(
        this.tripRequestValue.start_date
      )}`]: flyZoneOutbound,
      [`Fly Zone inbound - ${this.dateToString(
        this.tripRequestValue.end_date
      )}`]: flyZoneInbound,
