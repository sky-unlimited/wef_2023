...
class WeatherTiles
  ...
  def initialize(current_user, airport, start_date, end_date = nil)
    ...
    @flyzone_polygon = nil          # The final polygon that should union the adjacent good weather tiles
    ...
    propagation_algo(x_tile_init, y_tile_init) unless start_date_weather_ok = false
